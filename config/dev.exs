...
config :ho_mon_radeau, HoMonRadeauWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "eh3rAOk5PRuZioPZIZdEofS0FCFCEkR+IRr1J6FkLk9OF67mj134Wbs/endWzBGV",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:ho_mon_radeau, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:ho_mon_radeau, ~w(--watch)]}
  ]
...
config :ho_mon_radeau, HoMonRadeauWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/ho_mon_radeau_web/router\.ex$",
      ~r"lib/ho_mon_radeau_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :ho_mon_radeau, dev_routes: true
...
# Configure Swoosh to use mailcatcher for development
